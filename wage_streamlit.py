...
df_ts_mean = df_ts_mean.rename(columns = {'一人当たり賃金（万円）': '全国の一人当たり賃金（万円）'})
...
df_mean_line = df_mean_line[['集計年', '全国の一人当たり賃金（万円）', '一人当たり賃金（万円）']]
...
select_wage = st.selectbox (
  '賃金の種類',
  (wage_list)
)

df_cat_year = df_jp_category[df_jp_category['集計年'] == select_year]

max_x = df_cat_year[select_wage].max() + 50
